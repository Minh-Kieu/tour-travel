...
const Home = () => {
  const { data: tours, isLoading } = useQuery(['toursService.getTours'], () => toursService.getTours());

  const { data: atractiveTours, isLoading: isLoadingAtractiveTours } = useQuery(['toursService.atractiveTours'], () =>
    ...
    <div>
      ...
      <Container maxWidth='lg' className='px-4 lg:p-0'>
        <div className='py-16 text-center'>
          ...
          <p className='text-sm text-[#B2B2B2]'>Chúng ta vẫn biết rằng, làm việc với một đoạn văn bản dễ đọc.</p>
        </div>
