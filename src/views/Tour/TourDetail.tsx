...
import { Container, Rating, Tab, TextField, Card, CardContent } from '@mui/material';
...
const TourDetail = () => {
  ...
  const { data: allTours, isLoading: isLoadingAllTours } = useQuery(['toursService.getTours'], () =>
    toursService.getTours(),
  );

  const { data: tour, isLoading } = useQuery(['toursService.getToursID', { tourID }], () =>
    toursService.getToursID({ id: tourID! }),
  );
